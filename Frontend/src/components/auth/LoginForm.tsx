...
export function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (res.success && res.data) {
      ...
      // Now update Zustand store with user info.
      setAuth(
      ...
      // router.push works now because the cookie is already set —
      // middleware will read it and allow the /dashboard route through.
